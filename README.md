## Formulário Simples com Validação (apenas Frontend)
<p align="center">
<img src="https://i.ibb.co/jMwF1wS/Agrotis-Image.png" alt="Agrotis-Image" width="80%" border="0">
 </p>
<p align="center">
...
Um formulario simples com validação nos campos obrigaórios e notificação de erros e retorno de sucesso.
...
Cadastro do formulário seguindo o seguinte modelo (* campos obrigatórios): 
  - Contato 
    - Nome*
    - Data Inicial*
    - Data Final*
